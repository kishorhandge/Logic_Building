...
#
# An e-commerce platform calculates final payable amount
# based on purchase amount and membership type.
#
# Discount Rules:
#   - Amount > 5000 → 20% discount
#   - Amount > 2000 → 10% discount
#   - Otherwise → No discount
#   - Premium members → Extra 5% discount on discounted amount
#
# Input:
