...
class Assignment_62_3 
{
    public static void main(String A[]) throws Exception
    {
        ...
        {   
            ...
            int size = fiobj.available();   // total file size

            fiobj.skip(size - iNo);         // move pointer to last N bytes

            iRet = fiobj.read(Buffer);      // read last N bytes
            ...
            System.out.println("Last "+ iNo + " bytes succesfully copied into the file:");
